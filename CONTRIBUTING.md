...
4. Run the full check suite: `npm run lint && npm test`
5. Commit using [Conventional Commits](https://www.conventionalcommits.org/) (`feat:`, `fix:`, `docs:`, etc.)
6. Open a pull request

## Code Style

This project uses the TypeScript compiler for linting. Match the existing code style and run `npm run lint` before committing.
